...
namespace LaunchDarkly.Sdk.Client.Interfaces
{
    ...
    /// connection, but it could be polling or test data depending on your configuration.
    /// </para>
    /// <para>
    ...
    public interface IDataSourceStatusProvider
    {
        ...
        /// has become <see cref="DataSourceState.Shutdown"/> (since that is a permanent condition), or 3. the specified
        /// timeout elapses.
        /// </para>
        /// <para>
        ...
        /// changed to <see cref="DataSourceState.Shutdown"/> and that was not the desired state</returns>
