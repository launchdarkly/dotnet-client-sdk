...
namespace LaunchDarkly.Sdk.Client.Interfaces
{
    ...
    public struct DataSourceStatus
    {
        ...
        /// <item>For <see cref="DataSourceState.Shutdown"/>, it is the time that the data source encountered an unrecoverable error
        ...
        public enum ErrorKind
        {
            ...
            /// reported by the SDK whenever one of the update methods of <see cref="IDataSourceUpdateSink"/> throws an
            /// exception.
            /// </remarks>
            StoreError
        }
